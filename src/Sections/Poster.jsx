...
const Poster = () => {
    return (
        <motion.div
            ...
            className="w-11/12 mx-auto bg-[#F3F3F3] mt-10 mb-16 flex flex-col lg:flex-row gap-5 justify-between rounded-3xl h-auto lg:h-96 p-6 lg:p-0">

            {/* Left Section */}
            <div
                className="w-full lg:w-1/2 p-5 md:p-10 lg:p-20 text-center lg:text-left">
                <motion.h4
                ...
                <button className="relative overflow-hidden bg-gray-900 mt-3 text-white px-8 py-4 rounded-lg font-medium transition-colors duration-300 group">
            ...
            <motion.div
                ...
                className="hidden md:flex justify-center items-center lg:block">
                <motion.svg
                    width="500"
                    height="410"
                    viewBox="0 0 494 395"
